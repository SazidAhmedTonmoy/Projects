        ...
        <div class="row">
          <div class="col-md-9 bg-white padding-2">
            <div class="row margin-top-20">
              <div class="col-md-12">
               <?php
                   $sql = "SELECT * FROM job_list WHERE com_id='$_SESSION[com_id]' AND job_id='$_GET[id]'";
                ...
                <div class="pull-right" style='margin-top: 10px;'>
                  <a href="my_job_list.php" class="btn btn-default bg-success text-white btn-lg btn-flat margin-top-20"><i class="fa fa-arrow-circle-left"></i> Back</a>
                </div>
